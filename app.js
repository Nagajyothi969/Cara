// Mobile menu functionality — improved with overlay & a11y
...
function openNav() {
    ...
    if (close) close.setAttribute("aria-hidden", "false");
}
...
// Close nav when clicking backdrop (the ::after pseudo-element of body)
...
// Resize: auto-close nav and clean up body class when going desktop
